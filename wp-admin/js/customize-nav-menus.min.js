!function (a, b, c) {
    ...
    wpNavMenu.originalInit = wpNavMenu.init, wpNavMenu.options.menuItemDepthPerLevel = 20, wpNavMenu.options.sortableItems = "> .customize-control-nav_menu_item", wpNavMenu.options.targetTolerance = 10, wpNavMenu.init = function () {
        ...
        initialize: function () {
            var b = this;
            this.$search = c("#menu-items-search"), this.sectionContent = this.$el.find(".accordion-section-content"), this.debounceSearch = _.debounce(b.search, 500), _.bindAll(this, "close"), c("#customize-controls, .customize-section-back").on("click keydown", function (a) {
        ...
        initialize: function (b, c) {
            ...
            d && (b = a.section(d), b && b.expanded() && c.actuallyEmbed())
            ...
            b.setting.bind(function (c) {
                if (c) {
                    ...
                    c.title ? d.text(c.title).removeClass("no-title") : d.text(a.Menus.data.l10n.untitled).addClass("no-title")
                }
            })
        }, getDepth: function () {
            ...
            this.expandControlSection(), this.expandForm(), this.container.find(".menu-item-settings :focusable:first").focus()
        }, moveUp: function () {
        ...
        ready: function () {
            ...
            b.on("sortstart", function () {
                ...
                setTimeout(function () {
                    ...
                    c.isSorting = !1, _.each(b, function (b) {
                        var c, e, f;
        ...
        _(d.nav_menu_updates).each(function (d) {
            ...
            if ("inserted" === b.status) {
                ...
                if (f = a(c), !a.control.has(c))throw new Error("Expected control to exist: " + c);
                if (i = a.control(c), h = f.get(), !h)throw new Error("Did not expect setting to be empty (deleted).");
                h = _.clone(h), e[h.nav_menu_term_id] && (h.nav_menu_term_id = e[h.nav_menu_term_id]), d = "nav_menu_item[" + String(b.post_id) + "]", g = a.create(d, d, h, {
                    type: "nav_menu_item",
                    transport: "postMessage",
                    previewer: a.previewer
                }), j = new a.controlConstructor.nav_menu_item(d, {
                    params: {
                        type: "nav_menu_item",
                        ...
                        menu_id: b.post_id,
                        section: "nav_menu[" + String(h.nav_menu_term_id) + "]",
                        priority: i.priority.get(),
                        active: !0,
                        settings: {"default": d},
                        menu_item_id: b.post_id
                    }, previewer: a.previewer
                }), i.container.remove(), a.control.remove(c), a.control.add(d, j), f.callbacks.disable(), f.set(!1), f.preview(), g.preview(), f._dirty = !1, j.container.toggleClass("menu-item-edit-inactive", i.container.hasClass("menu-item-edit-inactive"))
            }
