    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                ...
                <iframe width="100%" height="415" src="https://www.youtube.com/embed/VVzLw1xmypQ" frameborder="0" allowfullscreen></iframe>
            </div><!-- end col -->
        </div><!-- row -->
    </div><!-- container -->
</section><!-- featurette -->
            ...
            <div class="col-sm-8 col-md-6">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <a href="https://facebook.com/<?php echo $facebook_username; ?>" target="_blank"><i class="fa fa-facebook"></i></a>
                        <?php endif; ?>

                        <?php if( !empty($google_plus_username) ): ?>
                        <a href="https://plus.google.com/<?php echo $google_plus_username; ?>" target="_blank"><i class="fa fa-google-plus"></i></a>
                        <?php endif; ?>
                    </div><!-- end col -->
