...
!function () {
    ...
    var b, c = function (a) {
        ...
        "undefined" != typeof jQuery ? jQuery(document).ready(a) : (b = c, b.funcs = [], b.ready = function () {
            if (!b.isReady)for (b.isReady = !0, d = 0; d < b.funcs.length; d++)b.funcs[d]()
    ...
    b = QTags = function (a) {
        if ("string" == typeof a)a = {id: a}; else if ("object" != typeof a)return !1;
        ...
        var k;
        if (a && c) {
            if (h = h || 0, e = e || "", j = j || {}, "function" == typeof d)k = new b.Button(a, c, f, g, i, j), k.callback = d; else {
    ...
    }, edButtons[10] = new b.TagButton("strong", "b", "<strong>", "</strong>", "", "", "", {
